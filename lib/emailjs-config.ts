...
export const EMAILJS_CONFIG = {
  ...
  SERVICE_ID: process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || 'service_n9ihigq',
  TEMPLATE_ID: process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || 'template_gkhcy08',
...
/*
Template Name: template_gkhcy08
...
4. Get your Public Key:
   ...
   - Copy your Public Key (x9Mlm_5Uv0iRxcxdN)

5. The contact form will automatically send emails to devr01499@gmail.com
*/
