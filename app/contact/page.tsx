...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-navy-900">
      ...
      <section id="contact-form" className="py-24 bg-secondary-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Contact Information */}
            <div>
              <h2 className="text-4xl font-heading font-bold text-navy-900 mb-8">
                Get In Touch
              </h2>
              
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-electric-500 to-coral-500 rounded-xl flex items-center justify-center flex-shrink-0">
                    <EmailIcon className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl font-heading font-bold text-navy-900 mb-2">Email Us</h3>
                    <p className="text-neutral-600 mb-1">Management@admirerx.net</p>
                    <p className="text-sm text-neutral-500">We typically respond within 2-4 hours during business hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-heading font-bold text-navy-900 mb-2">Call Us</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-heading font-bold text-navy-900 mb-2">Business Hours</h3>
                    <p className="text-neutral-600 mb-1">Monday - Friday: 9:00 AM - 6:00 PM</p>
                    <p className="text-sm text-neutral-500">Saturday: 10:00 AM - 2:00 PM</p>
                  </div>
                </div>
              </div>

              <div className="mt-12 p-6 bg-gradient-to-r from-electric-500/10 to-coral-500/10 rounded-2xl">
                <h3 className="text-xl font-heading font-bold text-navy-900 mb-4">Why Choose AdmirerX?</h3>
                <ul className="space-y-2">
                  <li className="flex items-center text-neutral-600">
                    <CheckIcon className="w-5 h-5 text-electric-500 mr-3 flex-shrink-0" />
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <h3 className="text-2xl font-heading font-bold text-navy-900 mb-6">Book Appointment</h3>
              ...
              {isSubmitted ? (
                <div className="text-center py-8">
                  ...
                  <h4 className="text-xl font-heading font-bold text-navy-900 mb-2">Thank You!</h4>
                  <p className="text-neutral-600">We'll get back to you within 2-4 hours during business hours.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="focus" className="block text-sm font-medium text-navy-900 mb-2">
                      I'm interested in
                    </label>
                    <select
                      id="focus"
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-electric-500 to-coral-500 text-white font-semibold rounded-xl hover:from-electric-600 hover:to-coral-600 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
