...
const emailConfig = {
  ...
  auth: {
    user: process.env.EMAIL_SERVER_USER || 'devr01499@gmail.com',
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const adminMailOptions = {
      from: `"ADMIRERX Website" <${process.env.EMAIL_FROM || process.env.EMAIL_SERVER_USER}>`,
...
Please respond to this inquiry at your earliest convenience.
    ...
    const userMailOptions = {
      from: `"ADMIRERX" <${process.env.EMAIL_FROM || process.env.EMAIL_SERVER_USER}>`,
      to: email,
